 ...
 */
export const DEFAULT_COLORS: DisplayColors = {
  primary: '#6C63FF',
  secondary: '#4CAF50',
  background: '#F5F5F5',
  text: '#333333',
...
export class Display {
  ...
  getBackgroundColor(defaultColor: string = DEFAULT_COLORS.primary): string {
  ...
  getTextColor(defaultColor: string = '#FFFFFF'): string {
 ...
 */
export function getPlaceholderColor(str: string): string {
  const colors = [
