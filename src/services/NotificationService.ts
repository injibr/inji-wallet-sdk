...
export class NotificationService {
  ...
  private readonly DEVICE_MAPPING_ENDPOINT = 'device-mapping';

  constructor(notificationBaseUrl: string = 'https://vcdemo.crabdance.com') {
   ...
   */
  async registerDeviceMapping(
    cpfNumber: string,
    deviceFcmToken: string
  ): Promise<DeviceMappingResponse> {
    try {
      ...
      const requestBody: DeviceMappingRequest = {
