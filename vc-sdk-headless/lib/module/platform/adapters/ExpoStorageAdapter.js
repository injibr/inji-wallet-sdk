...
export class ExpoStorageAdapter {
  ...
  async generateRandomKey() {
    try {
      const Crypto = require('expo-crypto');
      return await Crypto.getRandomBytesAsync(32).then(bytes => Array.from(bytes, byte => byte.toString(16).padStart(2, '0')).join(''));
    } catch (error) {
...
//# sourceMappingURL=ExpoStorageAdapter.js.map