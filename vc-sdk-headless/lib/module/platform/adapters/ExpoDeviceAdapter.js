 ...
 */
export class ExpoDeviceAdapter {
  constructor() {}
  async initialize() {
    try {
  ...
  async getDeviceCapabilities() {
    try {
      return {
        hasCamera: true,
        // Most devices have camera
        hasBiometrics: false,
        // Would need expo-local-authentication to check
        hasNFC: false,
        // Expo doesn't have NFC support
...
//# sourceMappingURL=ExpoDeviceAdapter.js.map